  ...
  <div>
    ...
    <Wrapper display="grid">
      <div className="flex flex-col mb-20 sm:mb-36 w-full">
        <h1
          id="our-mission"
          className="text-center font-semibold text-mobile-h py-8 sm:py-16 sm:text-4xl lg:text-6xl "
        >
          Our Mission
        </h1>
        <p className="mx-6%">
    ...
    <div className=" w-full sm:pb-36">
      <div className="flex flex-col m-auto max-w-screen-xl sm:w-11/12 md:w-4/5">
        <h1
          id="meet-the-team"
          className="text-center h-full font-semibold text-mobile-h py-16 sm:py-16 sm:text-4xl lg:text-6xl "
        >
          Meet the team
        </h1>
