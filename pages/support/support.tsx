...
export default function Support() {
  return (
    <div className="h-auto md:h-screen lg:h-auto 2xl:h-screen">
      <Gradient title="Support" />
      <div
        id="squares-container"
        className="mx-std py-8 grid justify-items-center place-content-around gap-10 grid-cols-2 sm:gap-16 sm:-mt-36 sm:grid-cols-3 md:-mt-40 xl:-mt-44 2xl:gap-32 2xl:mx-auto max-w-screen-2xl"
      >
