      ...
      <div id="page-container" className="flex h-auto">
        <div className="shadow-term-panel pr-5 hidden sm:block">
          <ul className=" sm:w-32 sm:ml-20 sm:text-sm md:w-40 md:ml-24 md:text-base lg:w-44 lg:text-lg mt-10 space-y-7">
            ...
            <li>
              <a href="#terms" className="font-normal">
                Terms & Conditions
              </a>
            </li>
            <li>
            ...
            <li>
              <a href="#payment" className="font-normal">
                Payment Terms
              </a>
            </li>
            <li>
              <a href="#disclosures" className="font-normal">
                Disclosures
              </a>
            </li>
          </ul>
        </div>
        <div className="ml-6% mt-10 h-screen overflow-y-auto pb-80">
