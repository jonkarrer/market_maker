...
export default function Terms() {
  return (
    <div>
      ...
      <div
        id="colorful-stripe"
        className="text-white font-semibold flex items-center h-28 sm:h-44 bg-gradient-to-r from-salmon to-dk-pink"
      >
        <h1 className="mx-std text-4xl sm:text-6xl">Terms and Privacy</h1>
      </div>
      <div id="page-container" className="flex pb-5">
        <div className="shadow-term-panel h-screen ml-std pr-5">
        ...
        <div className="mx-std mt-10">
          <h2 className="text-3xl mb-5">Not Financial Advice</h2>
          ...
          <h2 className="text-3xl mt-8% mb-5">Terms and Conditions</h2>
          <p className="font-normal">
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec
            vulputate augue viverra nisi pretium, sed maximus lacus pulvinar.
            Curabitur vitae laoreet ligula, et porttitor velit. Suspendisse sit
          ...
          <h2 className="text-3xl mt-8% mb-5">Payment Terms</h2>
          <p className="font-normal">
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec
            vulputate augue viverra nisi pretium, sed maximus lacus pulvinar.
            Curabitur vitae laoreet ligula, et porttitor velit. Suspendisse sit
          ...
          <h2 className="text-3xl mt-8% mb-5">Disclosures</h2>
          <p className="font-normal">
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec
            vulputate augue viverra nisi pretium, sed maximus lacus pulvinar.
            Curabitur vitae laoreet ligula, et porttitor velit. Suspendisse sit
