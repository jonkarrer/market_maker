      ...
      <div>
          ...
          >
            ...
            <article className="space-y-5">
              ...
              <p className="sm:mr-5 sm:text-sm xl:text-xl 2xl:text-1.3vw">
                ...
                veritatis harum mollitia iste, magni nam unde ut error. Enim
                culpa quisquam impedit unde pariatur! <br /> <br />
                Lorem ipsum dolor sit amet consectetur adipisicing elit.
                Exercitationem, mollitia eaque. Neque animi perferendis, ducimus
                veritatis harum mollitia iste, magni nam unde ut error. Enim
                culpa quisquam impedit unde pariatur!
              </p>
            </article>
          </div>
          <div
        ...
        >
          ...
          <p className="text-center text-white text-base mx-std pt-3 sm:text-1.5vw sm:mx-std sm:mt-8">
            Our team has a diverse background of academic and industry
            experiences including finance, engineering, and media. We aren't
            paid by in large by the banks, we don't sell your information, we
            stay commited to the average investor
          </p>
        </section>
      </div>
    </div>
