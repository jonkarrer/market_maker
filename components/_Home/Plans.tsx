export default function Plans(): JSX.Element {
  return (
    <section className="grid gap-16 md:gap-32">
      <h2 className="text-center leading-normal m-auto md:w-2/3 lg:w-auto">
        Try free or sign up for premium features
      </h2>

      <div className="m-auto w-5/6 max-w-screen-2xl grid gap-16 md:w-full md:grid-cols-3 md:gap-0 lg:w-86% lg:px-0 2xl:w-9/12">
        <Plan>
          <h3>Free</h3>
